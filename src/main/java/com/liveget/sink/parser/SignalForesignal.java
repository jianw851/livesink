...
public class SignalForesignal extends Signal {

    public SignalForesignal() {}

    public static SignalForesignal getInstance() {
        if(INSTANCE == null) {
            INSTANCE = new SignalForesignal();
        }
        return (SignalForesignal) INSTANCE;
    }

    public void setRecord(String record) throws Exception {
        getInstance();
        // foresignal adds stoploss price to the signal
        // CHF_JPY|2020-09-09 12:02 EDT|2020-09-08T19:52:29.940|116.342|117.01535|116.302|69.66|14400|14400
